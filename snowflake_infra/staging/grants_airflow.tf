resource "snowflake_grant_privileges_to_account_role" "airflow_dev_warehouse" {
  privileges        = ["USAGE"]
...
resource "snowflake_grant_privileges_to_account_role" "airflow_dev_database" {
  privileges        = ["USAGE"]
  account_role_name = snowflake_account_role.airflow_dev_role.name
  on_account_object {
...
resource "snowflake_grant_privileges_to_account_role" "airflow_dev_stage" {
  privileges        = ["USAGE"]
  account_role_name = snowflake_account_role.airflow_dev_role.name
  on_schema_object {
    object_type = "STAGE"
...
resource "snowflake_grant_privileges_to_account_role" "airflow_dev_file_format" {
  privileges        = ["USAGE"]
  account_role_name = snowflake_account_role.airflow_dev_role.name
  on_schema_object {
...
resource "snowflake_grant_privileges_to_account_role" "airflow_dev_bronze_tables" {
...
resource "snowflake_grant_privileges_to_account_role" "airflow_dev_bronze_future_tables" {
  privileges        = ["INSERT", "SELECT"]
  account_role_name = snowflake_account_role.airflow_dev_role.name
  on_schema_object {
    future {
...
resource "snowflake_grant_privileges_to_account_role" "airflow_dev_postgres_stage" {
  privileges        = ["READ", "WRITE"]
  account_role_name = snowflake_account_role.airflow_dev_role.name
  on_schema_object {
    object_type = "STAGE"
...
resource "snowflake_grant_privileges_to_account_role" "airflow_dev_postgres_file_format" {
  privileges        = ["USAGE"]
  account_role_name = snowflake_account_role.airflow_dev_role.name
  on_schema_object {
    object_type = "FILE FORMAT"
